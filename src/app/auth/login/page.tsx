    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f1a2e] via-[#1a2a4a] to-[#0f1a2e] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <p className="text-sm text-text-muted text-center mb-6">Sign in to continue to HeroRank</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm text-text-secondary cursor-pointer">
                <input type="checkbox" checked={remember} onChange={e => setRemember(e.target.checked)} className="w-4 h-4 rounded accent-teal" />
                Remember me
              </label>
          ...
          <p className="text-sm text-text-muted text-center mt-6">
            ...
            <Link href="/auth/signup" className="text-teal font-semibold hover:underline">Sign up here</Link>
          </p>
        </div>
      </div>
    </div>
